...
public final class TableView {
    ...
    public TableView(Board board, int tableWidth, List<String> headersList, List<List<String>> rowsList) {
        this.board = board;
        if (tableWidth <= 0) {
    ...
    public TableView(Board board, int tableWidth, List<String> headersList, List<List<String>> rowsList, List<Integer> colWidthsList) {
    ...
    public TableView(Board board, int tableWidth, List<String> headersList, List<List<String>> rowsList, List<Integer> colWidthsList, List<Integer> colAlignsList) {
    ...
    public TableView setHeadersList(List<String> headersList) {
        this.headersList = headersList;
        return this;
    }
    ...
    public TableView setRowsList(List<List<String>> rowsList) {
        this.rowsList = rowsList;
        return this;
    }
    ...
    public TableView setColWidthsList(List<Integer> colWidthsList) {
        if (colWidthsList.size() != headersList.size()) {
            throw new RuntimeException("Column width count(" + colWidthsList.size() + ") and header size(" + headersList.size() + ") are not equal");
        } else {
            this.colWidthsList = colWidthsList;
    ...
    public TableView setColAlignsList(List<Integer> colAlignsList) {
        if (colAlignsList.size() != headersList.size()) {
            throw new RuntimeException("Column align count(" + colAlignsList.size() + ") and header size(" + headersList.size() + ") are not equal");
        } else {
            this.colAlignsList = colAlignsList;
    ...
    public TableView setHeaderHeight(int headerHeight) {
    ...
    public TableView setRowHeight(int rowHeight) {
    ...
    public TableView setGridMode(int gridMode) {
